                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="side-header side-content bg-white-op">
                            ...
                            <a class="h5 text-white" href="/panel/home.php">
                                ...
                                <i class="si si-<?php echo htmlentities($logo); ?> text-primary"></i> <span class="h4 font-w600 sidebar-mini-hide">quick-booter.xyz</span>
						...
						<li>
                                    ...
                                    <a href="products.php" <?php if (basename($_SERVER['PHP_SELF']) == "products.php") { ?> class="active" <?php } ?>><i class="si si-credit-card"></i><span class="sidebar-mini-hide">Plans	</span></a>
