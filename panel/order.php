				...
				<div class="block">
					...
					<div class="block-content">
						...
						<div class="alert alert-success text-center">
							<h3><strong>You have $<?php echo $row['price']; ?> to pay!</strong> </h3>
							<p>paypal: sadcenterek@gmail.com</p>
							<p>skrill: sadcentertv@protonmail.com</p>
							<p>bitcoin/eth: 19GHPAxbaboK8MEHnMfTQV1AKe3PWvnYbk</p>
